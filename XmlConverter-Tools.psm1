...
#-----------------------------------------------------------------------------#
#                                                                             #
#   Function        Set-NewFilename                                           #
#                                                                             #
#   Description     Sets a new fileextension for the file to indicate         #
#                   it is being worked on. It then returns the new filename   #
#                                                                             #
...
Function Set-NewFilename () {
    Param(
        ...
        [String]$filepath   #Full filepath     
    )
    try {
        Rename-Item $filepath "$filepath-busy"
        return "$filepath-busy"
    }
    catch {
        Write-Host "Error when renaming file: $_"
    }
}
...
#                                                                             #
#   Description     Reads a file and returns XML-object                       #
#                                                                             #
#   Arguments       See the Param() block                                     #
#                                                                             #
#   Notes                                                                     #
...
Function Get-XmlContent () {
    ...
    try {
        ...
        Write-Host "Error when reading XML: $_"
    }
}
...
#                                                                             #
#   Description     Returns a unique filename to be used when saving files    #
#                                                                             #
#   Arguments       See the Param() block                                     #
#                                                                             #
#   Notes                                                                     #
...
Function Get-UniqueFilename () {
    try {
        ...
        Write-Host "Error when generating unique filename: $_"
    }
}

#-----------------------------------------------------------------------------#
#                                                                             #
#   Function        Test-XmlLeaf                                              #
#                                                                             #
#   Description     Tests if an XML-element is a Leaf                         #
#                                                                             #
#   Arguments       See the Param() block                                     #
#                                                                             #
#   Notes                                                                     #
...
#-----------------------------------------------------------------------------#
#                                                                             #
#   Function        Get-XmlNodeType                                           #
#                                                                             #
#   Description     Returns the type of a XML-node if any                     #
#                                                                             #
#   Arguments       See the Param() block                                     #
#                                                                             #
#   Notes                                                                     #
...
Function Get-XmlNodeType () {
    ...
    $ElementName = $XmlElement.Name.ToUpper()
    $typePatterns = @{
        'STR-.+' = "TEXT";
        'BL-.+' = "BOOL";
        'TBL-.+' = "TABLE";
    ...
    foreach ($type in $typePatterns.GetEnumerator()) {
        if ($ElementName -match $type.Name) {
            return $type.Value
        }
    }
    if (! $strict) {
...
#-----------------------------------------------------------------------------#
#                                                                             #
#   Function        Get-XmlNodeName                                           #
#                                                                             #
#   Description     Returns the name of a XML-node                            #
#                                                                             #
#   Arguments       See the Param() block                                     #
#                                                                             #
#   Notes                                                                     #
...
Function Get-XmlNodeName () {
    ...
    foreach ($type in $typePatterns.GetEnumerator()) {
        if ($ElementName -match $type.Name) {
            return $XmlElement.Name.Substring(($Matches[0]).Length)
        }
    }
...
#-----------------------------------------------------------------------------#
#                                                                             #
#   Function        Test-XmlBoolean                                           #
#                                                                             #
#   Description     Checks if the content is a boolean                        #
#                                                                             #
#   Arguments       See the Param() block                                     #
#                                                                             #
#   Notes                                                                     #
...
function Test-XmlBoolean {
    ...
    try {
        if (($StringBool -eq $false) -or ($StringBool -eq $null)) {
            ...
            return [int]$StringBool
        }
    }
    catch {
        Write-Host "Error checking if boolean: $_"
    }
}
...
#                                                                             #
#   Description     Gets a checked or unchecked checkbox                      #
#                                                                             #
#   Arguments       See the Param() block                                     #
#                                                                             #
#   Notes                                                                     #
